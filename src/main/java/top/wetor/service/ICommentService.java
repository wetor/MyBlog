...
public interface ICommentService {
     ...
     * @return 回复列表
     */
    List<Comment> selectCommentPageByArticleId(Integer id, Integer begin, Integer number, Boolean asc);
     ...
     * @return 全部评论列表
     */
    List<Comment> selectCommentAllByArticleId(Integer id,Boolean asc);
